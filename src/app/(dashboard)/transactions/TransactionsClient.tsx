  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-panel rounded-2xl p-6 border border-blue-500/30 bg-blue-500/5">
          <p className="text-blue-400 text-sm font-medium mb-1">Revenue Fees (Recent)</p>
          <h3 className="text-3xl font-bold text-blue-400 tracking-tight">₦{stats.revenueFees.toLocaleString()}</h3>
        </div>
      </div>
              ...
              {filteredTransactions.length === 0 ? (
                ...
                filteredTransactions.map((tx) => (
                  <tr key={tx.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-4">
                      <p className="text-sm text-gray-300 font-mono text-xs truncate max-w-[100px]">{tx.userId}</p>
                    </td>
                    <td className="p-4">
