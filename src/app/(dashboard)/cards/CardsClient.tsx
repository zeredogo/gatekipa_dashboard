        ...
        <div className="p-4 border-b border-white/5 bg-white/5 flex gap-4">
          <div className="relative max-w-md flex-1">
            ...
            <input 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all"
            />
          </div>
        </div>
                  ...
                  <tr key={card.id} className="hover:bg-white/5 transition-colors">
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        <div className={`w-12 h-8 rounded flex items-center justify-center border border-white/10 ${card.status === 'active' ? 'bg-gradient-to-tr from-blue-600 to-blue-400' : 'bg-gradient-to-tr from-gray-600 to-gray-400 opacity-70'}`}>
                    ...
                    <td className="p-4">
                      {card.status === "active" ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2 py-1 bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded-full text-xs font-medium">
